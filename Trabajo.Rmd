...
security_data <- data.frame(
  ...
  `Autenticación y Autorización` = c("Azure Active Directory, MFA, SSO, Roles", 
                                      "SSO (SAML, LDAP, OAuth), Control granular", 
                                      "Qlik Account, SSO (SAML, OpenID Connect)"),
  `Seguridad de los Datos` = c("Encriptación en tránsito y reposo, RLS", 
                                "Encriptación en tránsito y reposo", 
                                "Encriptación en tránsito y reposo, Section Access"),
  `Conformidad y Certificaciones` = c("GDPR, HIPAA, SOC", 
                                       "SOC 2, ISO 27001, GDPR", 
                                       "GDPR, SOC 2")
)


kable(data, caption = "Comparación de Seguridad") %>%
  kable_styling(font_size = 9,
                latex_options = "HOLD_position") %>%
    column_spec(1, width = "10em") %>%
...
data <- data.frame(
  ...
  Conectividad = as.character(c(1, "1/3", 3, 5, 3, 5, 5, 3)),
  Transformación_de_Datos = as.character(c(3, 3, 5, "1/3", 5, 7, 5, 3)),
  Seguridad = as.character(c("1/3", "1/3", 1, 5, 3, 3, "1/5", "1/3")),
  Geolocalización = as.character(c(5, 3, 1, "1/3", "1/3", "1/3", "1/3", "1/7")),
  Interfaz_de_Usuario = as.character(c(5, 3, 3, "1/3", 5, 3, 3, 1)),
  Rendimiento_y_Escalabilidad = as.character(c("1/3", 3, 5, "1/3", 3, 5, 3, "1/3")),
  Soporte_y_Comunidad = as.character(c("1/5", 5, 3, "1/3", 3, 3, 5, "1/3")),
  Coste_y_Licenciamiento = as.character(c("1/7", 3, "1/3", "1/7", 1, "1/3", "1/3", 1))
)
...
data <- data.frame(
  ...
  Conectividad = c(0.04, 0.01, 0.13, 0.21, 0.17, 0.10, 0.24, 0.17),
